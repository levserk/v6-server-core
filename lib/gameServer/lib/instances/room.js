...
module.exports = class Room {
    ...
    getGameData() {
        return {
            ...
            score: this.getScore(),
            // TODO: clear history on round end, after saving game
            history: (this.gameData.state === 'waiting' || !this.gameData.shistory) ? '' : this.gameData.shistory,
    ...
    savePlayerTurn(userTurn, nextPlayerId) {
