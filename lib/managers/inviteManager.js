...
module.exports = class InviteManager extends Manager {
    ...
    onMessage(message) {
        ...
        return co(function* () {
            switch (message.type) {
                case "invite":
                    yield self.onInvite(message.sender, message.target, message.game, message.data);
                    break;
                case "cancel":
                    yield self.onInviteCancel(message.sender, message.target, message.game, message.data);
                    break;
                case "accept":
                    yield self.onInviteAccepted(message.sender, message.target, message.game, message.data);
                    break;
                case "reject":
                    yield self.onInviteRejected(message.sender, message.target, message.game, message.data);
                    break;
                case "random":
                    yield self.onPlayRandom(message.sender, message.game, message.data);
                    break;
                case "user_leave":
